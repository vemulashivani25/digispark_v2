  ...
  return (
    <div className="min-h-screen bg-black overflow-hidden">
      <Helmet>
        ...
        <meta
          name="description"
          content="Sign in or register for a DigiSpark account to access premium resources and features."
        />
      </Helmet>
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 flex items-center justify-center gap-4">
                  ...
                  <span className="flex flex-col md:flex-row md:items-center md:gap-3">
                    {showNewPassword ? (
                      ...
                      <>
                        <span className="text-white font-light tracking-tight">Welcome to</span>
                        <span className="relative inline-block">
                          <span className="relative z-10 font-bold tracking-tight">
                            <span className="bg-gradient-to-r from-white via-gray-100 to-white bg-clip-text text-transparent">
                              Digi
                            </span>
                            <span className="bg-gradient-to-r from-yellow-300 via-yellow-400 to-amber-500 bg-clip-text text-transparent drop-shadow-[0_0_25px_rgba(250,204,21,0.5)]">
                              Spark
                            </span>
                          </span>
              ...
              <div className="relative bg-gray-900/80 backdrop-blur-xl p-8 rounded-2xl border border-gray-700/50 shadow-2xl">
                {showNewPassword ? (
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <div className="relative group">
                                  <Lock
                                    className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500 group-focus-within:text-yellow-400 transition-colors duration-300"
                                    size={18}
                                  />
                                  <Input
                  ...
                  <Tabs defaultValue={activeTab} onValueChange={(value) => setActiveTab(value as "login" | "register")}>
                    <TabsList className="grid w-full grid-cols-2 mb-auto bg-gray-800/70 p-2 rounded-xl border border-gray-700/50">
                      <TabsTrigger
                        value="login"
                                ...
                                <FormItem>
                                  ...
                                  {password.length > 0 && (
                                    <div className="mt-2 space-y-1">
                                      ...
                                      <p
                                        className={`text-xs ${strength <= 2 ? "text-red-400" : strength <= 3 ? "text-yellow-400" : "text-green-400"}`}
                                      >
                                        {strengthLabel}
                                      </p>
                                    </div>
