    ...
    <footer className="bg-black relative overflow-hidden">
      ...
      <div className="border-b border-gray-800">
        <div className="container mx-auto px-4 py-16 relative">
          <div className="max-w-5xl mx-auto bg-gradient-to-r from-gray-900/80 to-gray-800/80 rounded-2xl backdrop-blur-sm p-8 md:p-12 border border-gray-700/50 shadow-lg">
              ...
              >
                <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
                  <input 
                    ...
                    className="flex-1 bg-gray-800 border border-gray-700 text-gray-300 px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-400"
                    value={emailValue}
                  ...
                  <Button 
                    type="submit" 
                    className="bg-yellow-400 hover:bg-yellow-300 text-black font-medium px-6 py-3 rounded-lg transition-colors"
                  >
                    Subscribe
                  </Button>
                </form>
      ...
      <div className="container mx-auto px-4 py-16 relative">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div>
            <h3 className="text-xl font-bold text-white mb-6 border-b border-gray-800 pb-3">About Us</h3>
            ...
            <div className="space-y-4">
              <div className="flex items-start text-gray-300">
                ...
                <a href="mailto:hello@digitalagency.com" className="hover:text-yellow-400 transition-colors">
              ...
              <div className="flex items-start text-gray-300">
                <MapPin className="w-5 h-5 mr-3 text-yellow-400 flex-shrink-0 mt-1" />
                <span>
              ...
              <ul className="space-y-4">
                {column.links && column.links.map((link) => (
                  <li key={link.name}>
                    ...
                    >
                      <ArrowRight className="w-4 h-4 mr-2 text-yellow-400/50 transform group-hover:translate-x-1 transition-transform" />
                      {link.name}
                    </a>
                  </li>
                ))}
                ...
                {column.posts && column.posts.map((post) => (
                  <li key={post.title}>
                    <a href={post.href} className="group">
                      <h4 className="font-medium text-gray-300 group-hover:text-yellow-400 transition-colors">
                        {post.title}
                      </h4>
